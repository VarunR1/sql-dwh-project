...
Purpose of the Script:
  The main purpose of this stored procedure is to load the data into the 'bronze' schema from external CSV files. 
The script have perfomed the following actions:
  1- Truncates the bronze tables before loading. 
  2- Used the 'Bulk Insert' command to load the data from CSV files to bronze tables.

Stored Procedure example query: Execute bronze.load_bronze;
------------------------------------------------------
*/
